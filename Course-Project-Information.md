...
Your visual application must....
    ...
    Create and deploy your visualization on the web. We prefer you use libraries and services that have been discussed/demoed in the course labs (e.g., D3 Links to an external site., Plot Links to an external site. Links to an external site.). Observable Framework Links to an external site.is a nice option for managing and deploying your data visualization application using the simplicity of Markdown combined with JavaScript.
...
Throughout the semester you will have five key milestones that help keep you on track and work as check-ins for you with your classmates and myself. These include:
    ...
    Project Final Deliverables [May 4]
        In the final week, you will submit a link to your deployed application (GitHub Pages) and a ZIP file containing all the code and documentation for generating this application. See link for detailed rubric.
    Project Presentation [May 5]
        In the final week, you will have 15 minutes to showcase your final project. In your presentation, you should justify your design and algorithm decisions, and explain the parts of your code that are driving the individual design views and interactions. See link for detailed rubric.
...
Visual Analytics Dashboard
    ...
    Loon: Using Exemplars to Visualize Large-Scale Microscopy Data Links to an external site., Lange et al. 2021, Sci Institute, University of Utah
    MIT Visualization Group COVID-19 Data Visualizations Dashboard Links to an external site., Lee et al. 2021 from MIT Visualization Group 
    RadEx: Integrated Visual Exploration of Multiparameteric Studies for Radiomic Tumor Profiling, Morth et al., 2020, UiB
    DimLift: Interactive Hierarchical Data Exploration thorugh Dimensional Bundling, Garrison et al. 2021, UiB
    IBM Watson News Explorer Links to an external site., IBM
    Weather Monitoring Dashboard Links to an external site., from ArcGIS
    Climate Cartographics Links to an external site.


Data-Driven Visual Story 

    Visualization of the Boston subway system Links to an external site., Barry & Card
    My life with Long COVID Links to an external site. , Georgia Lupi for NYTimes Opinion, Dec 2023
    24 hours in an invisible epidemic Links to an external site., The Pudding 
    The data visualizations behind COVID-19 skepticism Links to an external site., Lee et al. 2021 from MIT Visualization Group 
    Harry Stevens' simulitis visualizations Links to an external site.
...
NB: most of these recommendations are to facilitate web-based application development
    ...
    Vega-Lite Links to an external site. (JSON) / Vega-Altair Links to an external site. (Python) - high-level interactive grammars
    ThreeJS Links to an external site.- 3D JS library
    D3-tip Links to an external site. - library for tooltips with D3
    Observable Framework Links to an external site. - Deploy visualizations via Markdown + JS
